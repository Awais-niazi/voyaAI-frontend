    ...
    <div className="min-h-screen bg-[#faf9f7] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="font-serif text-3xl font-bold text-[#1a6b5c] mb-2">Welcome back</h1>
          <p className="text-[#5a5750]">Sign in to your Voya.ai account</p>
        </div>
        <div className="bg-white rounded-2xl shadow-sm border border-black/5 p-8">
          ...
          <p className="text-center text-sm text-[#8f8c85] mt-6">
            No account?{' '}
            <Link href="/register" className="text-[#1a6b5c] font-medium hover:underline">
              Create one
            </Link>
          </p>
        </div>
